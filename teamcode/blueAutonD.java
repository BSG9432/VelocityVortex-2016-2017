...
@Autonomous(name = "blueberries", group = "something")

public class blueAutonD extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (tape.getLightDetected() > .35) {
            ...
            frontRight.setPower(-.5);
            backLeft.setPower(.5);
            backRight.setPower(.5);                                 //go right towards white line
        }
        else {
            if (heyDude.getUltrasonicLevel() >= 16) {
                ...
                frontRight.setPower(-1);
                backLeft.setPower(1);
                backRight.setPower(-1);                             //go forward towards the wall
            }
            else {
