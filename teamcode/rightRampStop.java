...
@Autonomous(name = "rightRampStop", group = "something")

public class rightRampStop extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        sleep(1000);                //2             //go forward

        frontLeft.setPower(.5);
        frontRight.setPower(.5);
        backLeft.setPower(.5);
        backRight.setPower(.5);
        sleep(750);                //3              //turn right
...
//rawr XDDDDDDDDD
//dang that's one sexy code you got there boi. It makes me very hot inside and makes me want to learn how to code.
